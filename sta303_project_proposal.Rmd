---
title: "<center>Project Proposal - Predicting Life Expectancy</center>"
subtitle: "<center>STA303H1 S: Methods of Data Analysis II</center>"
author: "<center>Yinuo Zhao</center>"
date: "<center>Mar 12, 2024</center>"
output:
  html_document:
    html_preview: false
    css: styles.css
...
```{r}
link <- "https://raw.githubusercontent.com/inorrr/sta303_project/main/LifeExpectancyIndicators.csv"
if (!file.exists("LifeExpectancyIndicators.csv"))
  download.file(link, destfile = "LifeExpectancyIndicators.csv")
df <- data.table::fread("LifeExpectancyIndicators.csv")
```
